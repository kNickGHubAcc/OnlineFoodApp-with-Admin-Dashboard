...
<?php
    ...
    if(empty($_SESSION["user_id"])){        //Αν ο χρήστης δεν είναι συνδεδεμένος
        ...
        foreach ($_SESSION["cart_item"] as $item){
            ...
            if($_POST['submit']){           //Όταν ο χρήστης πατήσει το κουμπί 'Order Now'
                $SQL="insert into users_orders(u_id,title,quantity,price) values('".$_SESSION["user_id"]."','".$item["title"]."','".$item["quantity"]."','".$item["price"]."')";
                mysqli_query($db,$SQL);         //Καταχώρηση της παραγγελίας
                unset($_SESSION["cart_item"]);      //Αφαίρεση του cart item από το SESSION
                unset($item["title"]);
                unset($item["quantity"]);
                unset($item["price"]);
