...
<body>
	...
	<div class="page-wrapper">
		<div class="inner-page-hero bg-image" data-image-src="images/img/menuBg.jpg">
									...
									<tbody>
										<?php 
											...
											if(!mysqli_num_rows($query_res) > 0){
												echo '<td colspan="6"><center>You have not placed orders yet. </center></td>';
											}
											else{			      
										...
										<tr>
											...
											<td data-column="Action"> 
												<a href="delete_orders.php?order_del=<?php echo $row['o_id'];?>" onclick="return confirm('Do you want to cancel your order?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"> <i class="fa fa-trash-o" style="font-size:16px"></i> </a>
											</td>
										</tr>
										<?php }} ?>
									</tbody>
