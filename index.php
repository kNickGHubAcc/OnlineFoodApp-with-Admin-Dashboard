...
<body class="home">
    ...
    <section class="hero bg-image" data-image-src="images/img/menuBg.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Make your order online</h1>
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span style="color:yellow; font-weight:bold">1. </span>Choose Restaurant</h4>
                    </div>
                    <div class="step-item step2">
                        ...
                        <h4><span style="color:yellow; font-weight:bold">2. </span>Order Food</h4>
                    </div>
                    <div class="step-item step3">
                        ...
                        <h4><span style="color:yellow; font-weight:bold">3. </span>Delivery or take out</h4>
                    </div>
                </div>
            </div>
        </div>
