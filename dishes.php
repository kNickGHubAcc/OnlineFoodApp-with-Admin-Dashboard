...
<body>
    <header id="header" class="header-scroll top-header headrom">
        <nav class="navbar navbar-dark">
            <div class="container">
                ...
                <a class="navbar-brand" href="index.php" style="color:lime; font-weight:bold"> myOnlineDelivery </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <?php
                            if(empty($_SESSION["user_id"])){
                                ...
                                echo '<li class="nav-item"><a href="admin/index.php" class="nav-link active" onclick="openAdminPage(event)">Admin</a></li>';
                            }
						?>
                    </ul>
                </div>
    ...
    <div class="page-wrapper">
        <div class="top-links">
            <div class="container">
                <ul class="row links">
                    <li class="col-xs-12 col-sm-4 link-item"> <span>1</span><a href="restaurants.php">ChooseRestaurant</a> </li>
                    <li class="col-xs-12 col-sm-4 link-item active"> <span>2</span><ahref="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your favorite food</a> </li>
                    ...
                    <div class="menu-widget" id="2">
                        <div class="widget-heading">
                            <h3 class="widget-title text-dark">MENU
                                <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true"><i class="fa fa-angle-right pull-right"></i> <i class="fa fa-angle-down pull-right"></i> </a>
                            </h3>
                            <div class="clearfix"></div>
                        </div>
