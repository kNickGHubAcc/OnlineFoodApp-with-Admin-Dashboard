...
<head>
    ...
    <script language="javascript" type="text/javascript">
        var popUpWin=0;
        function popUpWindow(URLStr, left, top, width, height)       //Εμφανίζει ένα pop-up παράθυρο με διεύθυνση URL αυτήν που περνιέται σαν όρισμα
        {
            if(popUpWin){            //Αν επιχειρήσω να ανοίξω νέο παράθυρο, ενώ υπάρχει ήδη ένα ανοιχτό pop-up παράθυρο, τότε πρώτα θα κλείσει το ανοιχτό και μετά θα ανοίξει το νέο
...
<body class="fix-header fix-sidebar">
            ...
            <div class="scroll-sidebar bg-dark">
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a href="all_users.php">  <span><i class="fa fa-user f-s-20 "></i></span><span class="text-white">Users</span></a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="card card-outline-primary">
                                <div class="card-header">
                                    <h4 class="m-b-0 text-white text-center">View Order</h4>
                                </div>
                                <div class="table-responsive m-t-20 bg-dark">
    ...
    <footer class="footer bg-dark text-white"> © 2022 - Online Food Ordering System </footer>
