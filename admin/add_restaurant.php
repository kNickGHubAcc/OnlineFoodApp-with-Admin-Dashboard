...
<html lang="en">
    <?php
        ...
        if(isset($_POST['submit']))         //Αν ο χρήστης πατήσει το κουμπι 'Save'  
        {
            if(empty($_POST['c_name'])||empty($_POST['res_name'])||$_POST['email']==''||$_POST['phone']==''||$_POST['url']==''||$_POST['o_hr']==''||$_POST['c_hr']==''||$_POST['o_days']==''||$_POST['address']=='')         //Αν δεν έχουν συμπληρωθεί συγκεκριμένα πεδία
            {	
                ...
                $fname = $_FILES['file']['name'];           //Δες add_menu για σχόλια
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary bg-dark">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white text-center">Add Restaurant</h4>
                            </div>
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    <label class="control-label">Bussiness Email</label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="url" class="form-control form-control-danger" placeholder="www.example.com">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Opens at:</label>
                                                    <select name="o_hr" class="form-control custom-select bg-white">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Closes at:</label>
                                                    <select name="c_hr" class="form-control custom-select bg-white" >
                                                        <option>--Select--</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="o_days" class="form-control custom-select bg-white" data-placeholder="Choose a Category" tabindex="1">
                                                        <option>--Select--</option>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="c_name" class="form-control custom-select bg-white" data-placeholder="Choose a Category" tabindex="1">
                                                        <option>--Select--</option>
                                        ...
                                        <h3 class="box-title m-t-20 text-white">Restaurant Address</h3>
                                        <div class="row">
                                            <div class="col-md-12 ">
                                                <div class="form-group">
