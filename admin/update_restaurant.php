...
<html lang="en">
    <?php
        ...
        {
            if(empty($_POST['c_name'])||empty($_POST['res_name'])||$_POST['email']==''||$_POST['phone']==''||$_POST['url']==''||$_POST['o_hr']==''||$_POST['c_hr']==''||$_POST['o_days']==''||$_POST['address']==''){       //Αν κάποια συγκεκριμένα πεδία δεν έχουν συμπληρωθεί
                ...
                $fname = $_FILES['file']['name'];           //Δες σχόλια σε add_menu.php
                ...
                if($extension == 'jpg'||$extension == 'png'||$extension == 'gif'){        
                    if($fsize>=1000000){
                        $error='<div class="alert alert-danger alert-dismissible fade show">
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <strong>Max Image Size is 1MB.</strong> Try different Image.
                                </div>';
                    }
                    else{
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card card-outline-primary bg-dark">
                        <h4 class="m-b-0 text-white text-center">Update Restaurant</h4>
                            <div class="card-body">
