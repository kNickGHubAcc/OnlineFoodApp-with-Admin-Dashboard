                            ...
                            <div class="col-lg-12">
                                <div class="card card-outline-primary">
                                    <div class="card-header">
                                        <h4 class="m-b-0 text-white text-center">All Menues</h4>
                                    </div>
                                    <div class="table-responsive m-t-40">
                                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered bg-dark" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php
                                                    $sql="SELECT * FROM dishes order by d_id desc";     //Ανάκτηση των dishes με φθίνουσα σειρά id
                                                    $query=mysqli_query($db,$sql);
                                                    
                                                    if(!mysqli_num_rows($query) > 0 ){          //Αν δεν υπάρχουν αποθηκευμένα dishes στη βάση
                                                        echo '<td colspan="11"><center>There are no dishes.</center></td>';
                                                    }
                                                    else{				
                                                            ...
                                                            echo'<tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="col-md-3 col-lg-8 m-b-10">
                                                                            <center><img src="Res_img/dishes/'.$rows['img'].'" class="img-responsive  radius" style="max-height:300px;max-width:350px;" /></center>
                                                                        </div>
                                                                    </td>
                                                                    <td>
