...
<html lang="en">
    <?php
        ...
        if(isset($_POST['submit'])){            //Αν ο χρήστης πατήσει το κουμπί 'Save'
            if(empty($_POST['d_name'])||empty($_POST['about'])||$_POST['price']==''||$_POST['res_name']==''){       //Αν δεν έχουν συμπληρωθεί τα κατάλληλα πεδία
                ...
                <div class="col-lg-12">
                    <div class="card card-outline-primary bg-dark">
                        <div class="card-header">
                            <h4 class="m-b-0 text-white text-center">Update Dish</h4>
                        </div>
                        <div class="card-body">
