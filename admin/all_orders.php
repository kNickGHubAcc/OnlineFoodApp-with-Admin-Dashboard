                            ...
                            <div class="col-lg-12">
                                <div class="card card-outline-primary">
                                    <div class="card-header">
                                        <h4 class="m-b-0 text-white text-center">All Orders</h4>
                                    </div>
                                    <div class="table-responsive m-t-40">
                                        <table id="myTable" class="table table-bordered table-striped bg-dark">
                                            ...
                                            <tbody>
                                                <?php
                                                    $sql="SELECT users.*, users_orders.* FROM users INNER JOIN users_orders ON users.u_id=users_orders.u_id ";   //Ανάκτηση πληροφοριών για χρήστες και τις αντίστοιχες παραγγελίες τους
                                                    $query=mysqli_query($db,$sql);
                                                    
                                                    if(!mysqli_num_rows($query) > 0 ){          //Αν δεν έχουν γίνει καθόλου παραγγελίες
                                                        echo '<td colspan="8"><center>There are no Orders</center></td>';
                                                    }
                                                    else{				
                                                        while($rows=mysqli_fetch_array($query)){        //Για κάθε παραγγελία που έχει γίνει
                                                ?>
                                                            <?php
                                                                echo'<tr>
                                                                        <td>'.$rows['username'].'</td>
